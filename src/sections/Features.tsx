...
From small startups to large enterprises,our AI-driven tool has revolutionized the way businesses approach SEO.        </p>
        <div className="mt-10 grid gap-3 grid-cols-3">
        {tabs.map((tab) => (
          <div key={tab.title} className="border col-span-3 md:col-span-1  border-white/15 items-center flex p-2.5 rounded-xl gap-2.5">
            <div className="h-12 w-12 border border-white/15 rounded-lg flex justify-center items-center">
